...
- 默认接入 **30 个来源、7 个分类**，见[完整来源清单与采集规则](docs/sources.md)。其中 AINews 通过公开聚合 RSS 提供 X/Reddit 摘要，不要求用户拥有社媒账号；Telegram、Discord 未接入。来源可配置，总数上限 30，与运行报告接口一致；不宣称覆盖所有国际社媒。
